...
The principal contribution of this study is not that it reiterates well-known static dimorphism in pelvic dimensions. Those differences are real, and they are present in our data. What this study adds is a mechanical interpretation of how those differences are organised across the pelvic ring. Rather than treating the pelvis as a set of fixed diameters, the present framework describes it as a compliant ring with multiple deformation pathways that differ in mechanical accessibility and in how strongly they are recruited by different loads. That shift in viewpoint is important because it moves the discussion away from the question of whether the female pelvis is merely wider or narrower, and towards the question of how the ring is mechanically organised for routine support and childbirth-related demands.

That interpretation depends first on separating size from mechanics. Our modal analysis showed that raw eigenvalues were strongly shaped by scale, as expected for structures that are mechanically similar but differ in overall size. Near-isometric scaling of pelvic volume and the strong scale dependence of much of the raw spectrum mean that any claim based only on unadjusted eigenvalues would risk confounding organisation with size. Once scale was taken into account, however, sex effects persisted in selected modes. The relevant difference is therefore not simply that female pelves are smaller, but that stiffness is redistributed differently across the same ring system.

Conventional pelvic dimensions remain relevant in this framework, but their explanatory reach is limited. The cohort reproduced the expected sex differences in inlet dimensions, subpubic angle and outlet-related breadths, confirming that the sample behaves morphologically as anticipated. Yet those static measures accounted for only a modest fraction of the variance in sexually dimorphic pathways. The strongest single association was with PIT, which explained only a small proportion of the variance. Static dimensions, therefore, describe part of the structural setting, but they do not by themselves capture how the ring deforms under load.

The loading scenarios further explored the deformation patterns of a male and female pelvis. Here, bilateral and unilateral stances drew on the same low-order repertoire in both sexes, with bilateral stance dominating one mode and unilateral stance organised primarily around the first three eigenmodes. This shared backbone argues against interpreting the female pelvis as globally more lax or mechanically compromised for routine support. At the same time, the previously mentioned modal sex differences indicate a conserved support architecture that is selectively tuned.

That added value becomes clearest under childbirth-related loading. The inlet opening remained centred on one mode in both sexes (mode 9), so the female pattern is again not explained by switching to a different dominant mechanism. But the sexes differed in how they weighted that shared mechanism. Men concentrated more of the inlet-opening response into mode 9 itself, whereas women distributed more of the response across neighbouring low-order pathways, especially mode 4, while still retaining mode 9 as the principal axis. Outlet opening showed a comparable logic at a different locus: both sexes remained centred on mode 5, with sex differences appearing mainly in the secondary weighting of adjacent modes rather than in the identity of the dominant pathway. Once more, we see selective redistribution rather than wholesale remodelling of pelvic mechanics.

The confirmatory sensitivity tests improve the dynamic background, but they should be interpreted appropriately. Because these tests were performed on the template-based framework, they do not establish sex-specific soft-tissue properties directly, and they do not provide subject-specific causal proof. However, they can identify which components of the model exert the strongest control over the mechanically relevant pathways. For the principal inlet-opening mode, the strongest signals came from the pubic symphysis and anterior sacroiliac ligaments. This is important and mechanically elegant because it allows the pelvis to gain conditional access to opening-related deformation through soft-tissue adjustment. This is in line with the known mechanism of a small but important pelvic inlet opening at the time of delivery, with stabilisation maintained by posterior structures \cite{Hammer2013}, thus working like a clever compliance switch.

In our observation, one modal pathway uniquely links all otherwise separate observations (Mode 9). It is sex-biased but not female-exclusive. It is highly recruited by simulated inlet opening but not by habitual stance. It is only modestly predicted by static inlet dimensions. And it is strongly governed primarily by the pubic symphysis and anterior sacroiliac structures. This combination makes mode 9 the clearest childbirth-relevant deformation pathway in the present framework. We do not argue that mode~9 is \emph{the} obstetric mode in any absolute sense. Childbirth is too complex, and the models here are too idealised, for such a claim. Rather, mode~9 is the dominant mechanically interpretable route by which inlet-opening behaviour appears in the present dataset. Its biological relevance comes not from exclusivity but from its position within a network of related low-order modes and its reproducible association with obstetric loading.

Taken together, these findings support a more precise reformulation of the locomotion–childbirth problem. The data do not indicate two fundamentally different pelvic systems in women and men, nor do they suggest that childbirth-relevant compliance is achieved by sacrificing ordinary support function. Instead, the same balanced ring appears to maintain a common support backbone while redistributing the accessibility and recruitment of selected low-order deformation pathways under childbirth-related loading. This interpretation aligns with broader reassessments of the obstetrical dilemma, which argue that childbirth cannot be reduced to canal dimensions alone and that locomotor competence is not necessarily undermined by a wider or differently organized female pelvis [3–6]. The present study extends that debate by offering a population-scale mechanical formulation of how both demands may be accommodated in the same structure.
