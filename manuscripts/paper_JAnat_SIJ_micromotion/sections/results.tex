...
In the supporting allometric analysis, larger pelvic volume was associated with smaller motion: all 20 sex-specific slopes were negative and survived FDR correction. The exponents ranged from -1.062 to -0.366; the largest adjusted slope $q$ was 0.002. The inverse association with pelvic volume was therefore consistent across all five loading configurations. Full estimates and intervals are in Table~\ref{tab:allometry}.
